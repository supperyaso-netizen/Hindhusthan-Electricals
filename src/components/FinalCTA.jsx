  ...
  return (
    <section className="final-cta">
      <div className="container">
        <p className="eyebrow reveal-section" style={{ justifyContent: "center" }}>
          Visit us today
        </p>
        ...
        <p className="reveal-section reveal-delay-2">
          Find everything you need under one roof.
        </p>
        <div className="btn-row reveal-section reveal-delay-3">
